      ...
      <div className="h-[60%] w-2/4 relative left-10 top-[10%]   bg-white p-8 rounded-lg shadow-lg">
        <div className="flex relative top-5">
         ...
         <form className="space-y-4" onSubmit={handleSubmit}>
          ...
          <p onClick={()=> navigate('/login')} className="text-center relative top-2 cursor-pointer">Already have an account? <span className="text-blue-950 cursor-pointer">  Login </span></p>
